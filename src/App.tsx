...
function App() {
  return (
    <Container>
      ...
      <div className="voteBox">
        <div className="vote voteOne">
          ...
          <Button
            ...
            variant="contained"
            color="primary"
            className="vb voteForOne"
            endIcon={<ThumbUpIcon />}
          >
            vote for 1
          </Button>
        </div>
        <div className="vote voteTwo">
          <img
      ...
      <div className="table">leader board table</div>
    </Container>
  );
}
